package org.example.kafkatask.config;
...
import org.example.kafkatask.kafka.MessageDeserializer;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, ClientDto> consumerListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "org.example.kafkatask.dto.ClientDto"); // во что маппим? где это взять
